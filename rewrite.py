...
def create_spans(text):
    ...
    for c in text:
        if c == ' ':
            spans.append('<span class="hl-ch" style="translate: none; rotate: none; scale: none; filter: blur(0px); transform: translate(0px, 0px);">&nbsp;</span>')
        else:
            spans.append(f'<span class="hl-ch" style="translate: none; rotate: none; scale: none; filter: blur(0px); transform: translate(0px, 0px);">{c}</span>')
    return ''.join(spans)

new_h1_html = f'<h1>\n<span class="hero-mask"><span class="hero-line" data-split="">{create_spans("-.-- -.-- --..")}</span></span>\n<span class="hero-mask"><span class="hero-line" data-split="">{create_spans("Portal Rush Zine: A Jornada YYZ")}<span aria-hidden="true" class="red hero-dot hl-ch"></span></span></span>\n</h1>'
...
replacements = {
    ...
    "Ten years": "O Legado e",
    "chasing light": "Testemunhos",
    ...
    '<span class="mark"></span>PORTAL RUSH</a>': '<span class="mark"></span>POrtal Rush <span style="color: #FF5722;">ZIne</span></a>',
    '<span class="mark"></span>PORTAL RUSH</span>': '<span class="mark"></span>POrtal Rush <span style="color: #FF5722;">ZIne</span></span>'
}
